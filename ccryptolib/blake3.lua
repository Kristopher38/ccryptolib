...
local function compress(h, msg, t, v14, v15, full)
    ...
    local tmp
    for i = 1, 7 do
        v00 = (v00 + v04 + m00) % (2 ^ 32) v12 = rol(bxor(v12, v00), 16)
        v08 = (v08 + v12)       % (2 ^ 32) v04 = rol(bxor(v04, v08), 20)
        v00 = (v00 + v04 + m01) % (2 ^ 32) v12 = rol(bxor(v12, v00), 24)
        v08 = (v08 + v12)       % (2 ^ 32) v04 = rol(bxor(v04, v08), 25)

        v01 = (v01 + v05 + m02) % (2 ^ 32) v13 = rol(bxor(v13, v01), 16)
        v09 = (v09 + v13)       % (2 ^ 32) v05 = rol(bxor(v05, v09), 20)
        v01 = (v01 + v05 + m03) % (2 ^ 32) v13 = rol(bxor(v13, v01), 24)
        v09 = (v09 + v13 )      % (2 ^ 32) v05 = rol(bxor(v05, v09), 25)

        v02 = (v02 + v06 + m04) % (2 ^ 32) v14 = rol(bxor(v14, v02), 16)
        v10 = (v10 + v14 )      % (2 ^ 32) v06 = rol(bxor(v06, v10), 20)
        v02 = (v02 + v06 + m05) % (2 ^ 32) v14 = rol(bxor(v14, v02), 24)
        v10 = (v10 + v14 )      % (2 ^ 32) v06 = rol(bxor(v06, v10), 25)

        v03 = (v03 + v07 + m06) % (2 ^ 32) v15 = rol(bxor(v15, v03), 16)
        v11 = (v11 + v15 )      % (2 ^ 32) v07 = rol(bxor(v07, v11), 20)
        v03 = (v03 + v07 + m07) % (2 ^ 32) v15 = rol(bxor(v15, v03), 24)
        v11 = (v11 + v15 )      % (2 ^ 32) v07 = rol(bxor(v07, v11), 25)

        v00 = (v00 + v05 + m08) % (2 ^ 32) v15 = rol(bxor(v15, v00), 16)
        v10 = (v10 + v15 )      % (2 ^ 32) v05 = rol(bxor(v05, v10), 20)
        v00 = (v00 + v05 + m09) % (2 ^ 32) v15 = rol(bxor(v15, v00), 24)
        v10 = (v10 + v15 )      % (2 ^ 32) v05 = rol(bxor(v05, v10), 25)

        v01 = (v01 + v06 + m10) % (2 ^ 32) v12 = rol(bxor(v12, v01), 16)
        v11 = (v11 + v12 )      % (2 ^ 32) v06 = rol(bxor(v06, v11), 20)
        v01 = (v01 + v06 + m11) % (2 ^ 32) v12 = rol(bxor(v12, v01), 24)
        v11 = (v11 + v12 )      % (2 ^ 32) v06 = rol(bxor(v06, v11), 25)

        v02 = (v02 + v07 + m12) % (2 ^ 32) v13 = rol(bxor(v13, v02), 16)
        v08 = (v08 + v13 )      % (2 ^ 32) v07 = rol(bxor(v07, v08), 20)
        v02 = (v02 + v07 + m13) % (2 ^ 32) v13 = rol(bxor(v13, v02), 24)
        v08 = (v08 + v13 )      % (2 ^ 32) v07 = rol(bxor(v07, v08), 25)

        v03 = (v03 + v04 + m14) % (2 ^ 32) v14 = rol(bxor(v14, v03), 16)
        v09 = (v09 + v14 )      % (2 ^ 32) v04 = rol(bxor(v04, v09), 20)
        v03 = (v03 + v04 + m15) % (2 ^ 32) v14 = rol(bxor(v14, v03), 24)
        v09 = (v09 + v14 )      % (2 ^ 32) v04 = rol(bxor(v04, v09), 25)
